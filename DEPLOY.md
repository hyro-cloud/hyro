...
**Hermes Agent reference (skills & intelligence patterns, not a user install):** see [`docs/HERMES-REFERENCE.md`](docs/HERMES-REFERENCE.md). Users only install `hyro`; the brain runs on your VPS.
